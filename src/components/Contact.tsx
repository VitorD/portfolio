...
const contactLinks = [
  ...
  },
  {
    ...
    href: toWhatsAppUrl(profile.phone),
    external: true,
    icon: (
  ...
  {
    label: 'LinkedIn',
    description: 'Ver perfil profissional',
    ...
    <section id="contato" className="section contact">
      <div className="container">
        <div className="section__header">
          <span className="section__tag">05 — Contato</span>
          <h2 className="section__title">Vamos conversar?</h2>
          <p className="section__subtitle">
            Aberto a oportunidades, projetos e parcerias técnicas.
          </p>
        </div>
          ...
          {contactLinks.map((link) => (
            ...
            >
              ...
              <div>
                ...
                <span className="contact__value">{link.description}</span>
              </div>
            </a>
          ))}
        </div>
